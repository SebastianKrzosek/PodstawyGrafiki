...
private:
    ...
    void rysujPikselKolorem(int x, int y, int r, int g, int b);
    void pobranyKolor(int x, int y);
    void rysuj();
    void rysujLinie(int x0, int y0, int x1, int y1);
    void rysujOkrag();
    void rysujElipse();
    void rysujWielokat(int n);
    void zamaluj(int x, int y, int r, int g, int b);
    bool jakiKolor(int x, int y);
...
private slots:
    ...
    void on_radioButton_5_clicked(); //malowanie
    void on_checkBox_stateChanged(int arg1);
    void on_spinBox_valueChanged(int arg1);
    void on_pushButton_clicked(); //paleta
